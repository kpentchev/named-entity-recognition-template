...
with open('/Users/kpentchev/data/ner_2019_03_22_no_med_no_eve.csv', encoding='utf-8') as csv_read:
#with open('/home/kpentchev/data/floyd/ner_2019_02_25_fixed.csv', encoding='utf-8') as csv_read:
    ...
    line_count = 0
    sentence_count = 1
    with open('/Users/kpentchev/data/ner_2019_03_22_fixed.csv', encoding='utf-8', mode='w') as csv_write:
